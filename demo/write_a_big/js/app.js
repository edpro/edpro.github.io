...
(function (app) {
    ...
    var WritingOneGame = (function (_super) {
        __extends(WritingOneGame, _super);
        function WritingOneGame() {
        ...
        WritingOneGame.prototype.onFrameLabel = function (target, label) {
        ...
        WritingOneGame.prototype.onPlayClick = function () {
        ...
        WritingOneGame.prototype.updateAnim = function () {
        ...
        WritingOneGame.prototype.updateDrawing = function () {
        ...
        return WritingOneGame;
    }(app.AppScreen));
    app.WritingOneGame = WritingOneGame;
...
(function (app) {
    var PuzzleGame = (function (_super) {
        ...
        function PuzzleGame() {
            _super.call(this, "WritingGame");
            this.POSITION_DELTA = 10;
            this.parts = [];
            this.positions = [];
            this.draggedPart = null;
            this.draggedOffset = new PIXI.Point;
        }
...
(function (app) {
    ...
    games[app.GAME_WRITE_ONE] = function () { return new app.WritingOneGame(); };
