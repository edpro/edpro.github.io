...
(function (app) {
    var AppScreen = (function () {
        ...
        AppScreen.prototype.findByResName = function (prefix) {
            var result = [];
            for (var _i = 0, _a = this.content.children; _i < _a.length; _i++) {
                var child = _a[_i];
                if (!child.isFrameObject)
                    continue;
                var frameObject = child;
                if (frameObject.resource.name.indexOf(prefix) == 0)
                    result.push(frameObject);
            }
            return result;
        };
        ...
        AppScreen.prototype.configureAutoPlay = function (container) {
            ...
            container.children.forEach(function (it) {
                var frameObj = it;
                if (!frameObj.name && frameObj.totalFrames > 1 && _this.shouldAutoPlay(frameObj))
                    frameObj.animation.play();
                else if (it instanceof fl.Container)
                    _this.configureAutoPlay(it);
            });
        };
        AppScreen.prototype.shouldAutoPlay = function (obj) {
            return true;
        };
...
(function (app) {
    ...
    var WritingGame = (function (_super) {
        ...
        function WritingGame() {
            var _this = _super.call(this, "WritingGame") || this;
        ...
        WritingGame.prototype.onInitialize = function () {
            var _this = this;
            this.anim = new LetterAnim(this.content, "pointer");
            this.canvas = new DrawCanvas(this.content, this.anim.clip);
    ...
    var DrawCanvas = (function () {
        function DrawCanvas(content, anim) {
            var _this = this;
            ...
            content.addChildAt(this.sprite, content.getChildIndex(anim));
        ...
        DrawCanvas.prototype.drawLine = function (globalPos, lineWidth) {
            var points = this.points;
            var next = this.sprite.toLocal(globalPos);
            if (points.length == 0 || !points[points.length - 1].equals(next))
                points.push(next);
            if (points.length > 1) {
                var c = this.getContext();
                c.lineCap = 'round';
    ...
    var LetterAnim = (function () {
        ...
        LetterAnim.prototype.getPointerGlobalPos = function () {
            for (var i in this._clip.children) {
                var child = this._clip.children[i];
                if (child.isFrameObject && child.resource.name == "pointer")
                    return this._clip.toGlobal(child.position);
            }
            return null;
        };
        ...
        Object.defineProperty(LetterAnim.prototype, "clip", {
            get: function () {
                return this._clip;
            },
            enumerable: true,
...
(function (app) {
    var PuzzleGame = (function (_super) {
        ...
        PuzzleGame.prototype.onInitialize = function () {
            ...
            var partSprites = this.content.findAllByPrefix("part_");
...
(function (app) {
    var ColorGame = (function (_super) {
        ...
        function ColorGame() {
            var _this = _super.call(this, "ColorGame") || this;
            _this.positions = [];
            _this.buttons = [];
            _this.items = [];
            return _this;
...
(function (app) {
    ...
    var WordGame = (function (_super) {
        ...
        WordGame.prototype.initLetters = function () {
            var _this = this;
            var children = this.findByResName("letter_");
        ...
        WordGame.prototype.initPlacements = function () {
            var children = this.findByResName("placement");
            children.sort(xComparer);
            for (var i = 0; i < children.length; i++) {
        ...
        WordGame.prototype.onTickEvent = function () {
            if (this.draggedItem != null) {
                var localPos = this.content.toLocal(this.draggedItem.mousePos);
        ...
        WordGame.prototype.shouldAutoPlay = function (obj) {
            return obj.resource.name.indexOf("placement") < 0
                && obj.resource.name.indexOf("letter") < 0;
        };
        WordGame.prototype.onLetterPress = function (letter) {
            this.draggedItem = letter;
            this.draggedOffset = this.content.toLocal(letter.mousePos);
            ...
            this.content.setChildIndex(this.draggedItem.sprite, this.content.children.length - 1);
        };
...
(function (app) {
    ...
    app.GAME_WRITE = "write_one";
    app.GAME_COLOR = "color";
    app.GAME_WORD = "word";
    var games = {};
    games[app.GAME_PUZZLE] = function () { return new app.PuzzleGame(); };
    games[app.GAME_WRITE] = function () { return new app.WritingGame(); };
    ...
    function initialize(gameId) {
        ...
        if (app.DEBUG) {
            document.body.appendChild(_debug = document.createElement("div"));
    ...
    function loadGameScreen() {
        fl.Bundle.load(app.bundleId, function () {
            if (app.bundleId in games)
                changeScreen(games[app.bundleId]());
            else
                console.error("game constructor not found, bundleId: \"" + app.bundleId + "\")");
        });
    }
    ...
    function playSound(name) {
        ...
        _currentSound = new Howl({
            ...
            loop: false,
            volume: 1.0,
            onend: function () { delete _playingMap[name]; fl.Animation.sendSignal("snd"); },
    ...
    function trace(str) {
        console.log(str);
        if (app.DEBUG) {
            _debug.appendChild(document.createElement("td"));
            _debug.appendChild(document.createTextNode(str));
        }
    }
    app.trace = trace;
    function stopSound() {
        ...
        if (_currentSound) {
            ...
            sound.fade(sound.volume(), 0, 200, function () { return sound.unload(); });
            _currentSound = null;
        }
    }
